...
<motion.svg  className={`lucide max-[640px]:hidden absolute left-3 top-[31%] text-gray-300 h-6 w-6 lucide-phone ${cls2}`} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0,0,256,256">
